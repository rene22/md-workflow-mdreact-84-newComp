            ...
            props.baseTemplates[props.currentScreen].frame.map((frame) => (
                (() => {
                    switch (frame.type) {
                        ...
                        case 'action-type1':
                            if (props.gridList.find((table) => table.updatable === 'true') != undefined || props.switchedOn) {
                                return (
                                    <ActionType1Renderer
                                        frame={frame}
                                        {...props}
                        ...
                        case 'table-type1':
                            if (props.gridList.find((table) => table.id === frame.tableID && table.updatable === 'true') != undefined)
                                return (
                                    <UpdTableType1Renderer
                                        frame={frame}
                                        {...props}
                                    />
                                )
                                ...
                                return (
                                    <TableType1Renderer
                                        frame={frame}
                                        positionTypeframe={props.baseTemplates[props.currentScreen].frame
                                            .find((frame) => frame.type === "position-type1")}
                                        {...props}
                                    />
                                )
